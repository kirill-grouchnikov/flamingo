...
public class RibbonBandTestCase extends FestSwingJUnitTestCase {
    ...
    protected void onSetUp() {
        GuiActionRunner.execute(new GuiTask() {
            ...
            protected void executeInEDT() throws Throwable {
                ...
                taskCont1_1 = new RibbonTask("Context task 1 1",
                        createBand(6, "Context 11", "Test 11"));
                taskCont1_2 = new RibbonTask("Context task 1 2",
                        createBand(6, "Context 12", "Test 12"));
                taskCont1_3 = new RibbonTask("Context task 1 3",
                        createBand(6, "Context 13", "Test 13"));
                taskGroup1 = new RibbonContextualTaskGroup("Context 1", Color.red, taskCont1_1,
                        taskCont1_2, taskCont1_3);
                ...
                taskGroup2 = new RibbonContextualTaskGroup("Context 2", Color.blue, taskCont2_1,
                        taskCont2_2);
    ...
    public void testBands() {
        ...
        Assertions.assertThat(frame.getRibbon().getSelectedTask().getBandCount()).isEqualTo(2);
        Assertions.assertThat(frame.getRibbon().getSelectedTask().getBands().size()).isEqualTo(2);
    }

    @Test
    public void testSelectedTask() {
        Assertions.assertThat(frame.getRibbon().getSelectedTask()).isEqualTo(task1);
        ...
        robot().waitForIdle();
        Assertions.assertThat(frame.getRibbon().getSelectedTask()).isEqualTo(task2);
